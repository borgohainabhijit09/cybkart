            ...
            <div className="container mx-auto px-6 max-w-4xl">
                ...
                <div className="prose prose-slate max-w-none">
                    ...
                    <p className="mb-6 text-slate-600">
                        CYBKART GLOBAL provides white-label engineering, web development, and technical architecture services tailored for marketing agencies and professional partners. Specific deliverables, timelines, and costs are defined in individual Statements of Work (SOW) or Contracts signed by both parties. In the event of a conflict between these Terms and a specific SOW, the SOW shall control.
                    </p>

                    <h3 className="text-2xl font-bold text-slate-900 mt-12 mb-4">2. Intellectual Property Rights</h3>
                    <p className="mb-6 text-slate-600">
                        <strong>Agency Ownership & Resale:</strong> Upon full payment of all fees, CYBKART GLOBAL assigns to the Agency (Client) all right, title, and interest in the custom code, designs, and assets created specifically under the agreement. As a white-label partner, the Agency has full rights to rebrand, resell, and transfer these assets to their end-clients without restriction.
                    </p>
                    <p className="mb-6 text-slate-600">
